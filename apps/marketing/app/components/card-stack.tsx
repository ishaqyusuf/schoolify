...
import { useMediaQuery } from "@repo/utils";
      ...
      {cards.map((card, index) => {
        return (
          <motion.div
            ...
            onMouseEnter={() => clearInterval(interval)}
          >
            <div className="border-border overflow-hidden rounded-md border md:rounded-2xl">
              <TooltipProvider delayDuration={0}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      className="absolute left-[8px] top-[60px] z-20 h-[20px] w-[35px]"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      className="absolute left-[8px] top-[95px] z-20 h-[20px] w-[35px]"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      className="absolute left-[8px] top-[125px] z-20 h-[20px] w-[35px]"
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      className="absolute left-[8px] top-[160px] z-20 h-[20px] w-[35px]"
